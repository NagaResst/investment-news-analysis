...
在网络上搜索与基金/重仓股相关的最新资讯。搜索内容包括：
- 基金净值、基金经理观点、季报摘要
- 重仓股的财报、评级变动、行业动态
- 相关政策、宏观经济数据
- 权威来源：东方财富、新浪财经、证券时报、财联社、财新等
...
**相关持仓**：嘉实新能源新材料A(003984)(持仓8.37%，第一大重仓)
...
**保存位置**：
```
投资新闻归档/2026-04/2026-04-26/item_summaries/001_宁德时代Q1财报.md
```
...
**保存位置**：
```
投资新闻归档/2026-04/2026-04-26/raw_data/stocks/宁德时代.json
```
...
**输出文件**：
```
投资新闻归档/2026-04/2026-04-26/summary_2026-04-26.md
```
